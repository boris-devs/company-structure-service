...
class DepartmentParentTreeResponse(BaseModel):
    ...
    children: List["DepartmentParentTreeResponse"] = Field(
        validation_alias="safe_children", serialization_alias="children", default=[]
    )
...
class DepartmentDetailResponseSchema(BaseModel):
    ...
    department_id: Optional[int]
    created_at: datetime
    employees: List[EmployeeResponseSchema] = Field(
        validation_alias="safe_employees", serialization_alias="employees", default=[]
    )
    children: List["DepartmentParentTreeResponse"] = Field(
        validation_alias="safe_children", serialization_alias="children", default=[]
    )
